class LogsController < ApplicationController
  ...
  def remove_location
    ...
    if @log.user != current_user
      redirect_to(log_path(@log), alert: "You are not authorized to edit locations on this log.")
    elsif !@log_location_copy.present?
  ...
  def edit_cave_locations
    ...
    if @log.user != current_user
      redirect_to(log_path(@log), alert: "You are not authorized to edit locations on this log.")
    elsif !@cave.present? && @cave_locations_data.present?
  ...
  def add_cave
    ...
    elsif LogCaveCopy.find_by(log_id: @log.id, cave_id: @cave.id)
